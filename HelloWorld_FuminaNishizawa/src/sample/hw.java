...
public class hw {
	...
	public static void main(String[] args) {
		...
		System .out .println(byteNum + shortNum + intNum + longNum); //出力：　1110
			
		number = 20; //整数20を変数に代入
		System .out .println(byteNum); //出力：20
				
		System.out.println(letter); //出力：a
		System.out.println(letters); //出力：ハロー
		System.out.println(isHello); //出力：true
        ...
        int age;//変数を宣言
        age = 25;//変数を代入
        System.out.println("年齢" + age + "歳");//年齢25歳と表示
